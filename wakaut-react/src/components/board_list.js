    ...
    return(
        <>
            ...
            <Container>
                ...
                <List title='일요일에 축구할사람' note='아아닛!!! 축구를 한다고옷?' malcnt='15' img={true} col='bg-warning' time='2023-03-07' kd='community'/>
                <List title='데스매치 현피앱' note='광고사절입니당' malcnt='8' img={true} col='bg-warning' time='2023.03.08' kd='review'/>
                <List title='데스매치 현피앱' note='광고사절입니당' malcnt='8' img={true} col='bg-warning' time='2023.03.08' kd="community"/>
                <Paging cnt={5}/>
            </Container>
        </>
    )
