...
const BoardList=()=>{
    ...
    return(
        <>
            ...
            <Container>
                <List title='게시판 제목' note='이것은 테스트입니다..' malcnt='3' img={true} col='bg-warning' time='2023-03-07' kd='review' to="/board/boardview"/>
                <List title='일요일에 축구할사람' note='아아닛!!! 축구를 한다고옷?' malcnt='15' img={true} col='bg-warning' time='2023-03-07' kd='community' to="/board/boardview"/>
                <List title='데스매치 현피앱' note='광고사절입니당' malcnt='8' img={true} col='bg-warning' time='2023.03.08' kd='review' to="/board/boardview"/>
