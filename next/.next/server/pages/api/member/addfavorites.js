...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  const cnt = new _models_Member__WEBPACK_IMPORTED_MODULE_0___default.a().insertFvr(userid, facility, region, contact).then(res => res);
  res.status(200).json({
    cnt: await cnt
  });
  console.log("즐겨찾기 추가");
...
module.exports = __webpack_require__("2/aK");
