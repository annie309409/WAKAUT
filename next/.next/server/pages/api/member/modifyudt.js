...
module.exports = __webpack_require__("vvKq");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  console.log("회원정보수정 전달한 바디", req.body);
  const {
    userid,
    passwd,
    name,
  ...
  const cnt = new _models_Member__WEBPACK_IMPORTED_MODULE_0___default.a().updateInfo(userid, passwd, name, email, phone_number, gender, birth_date, agree_to_privacy_policy, agree_to_advertising_info).then(res => res);
  res.status(200).json({
    cnt: await cnt
  });
  console.log("회원정보 수정");
