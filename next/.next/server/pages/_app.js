...
// EXTERNAL MODULE: ./styles/boot-added.css
var boot_added = __webpack_require__("FIoO");
...
function Loading(props) {
  return __jsx(external_react_default.a.Fragment, null, __jsx(external_react_spinners_["HashLoader"], {
    size: "80px",
    color: "#A9DEFF",
...
function MyApp({
  ...
  return _app_jsx(external_react_default.a.Fragment, null, loading && _app_jsx(Loading, {
    loading: loading
  }), getLayout(_app_jsx(Component, pageProps)));
}

MyApp.getInitialProps = async ctx => {
  // next app의 기본 props객체 초기화
  //application단위의 전역변수
  const appProps = await app_default.a.getInitialProps(ctx);
  let sess = await Object(client_["getSession"])(ctx);
